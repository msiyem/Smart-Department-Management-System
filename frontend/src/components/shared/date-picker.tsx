  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          className={`
            ...
            border-slate-200 bg-slate-200 text-slate-700 dark:text-slate-200
      ...
      <PopoverContent
        align="start"
        className="
          w-auto rounded-xl border
          border-emerald-200 p-0
          shadow-lg
      ...
      >
        <Calendar
          ...
          classNames={{
            ...
            weekday:
              "w-7 text-[0.72rem] font-semibold text-emerald-700 dark:text-emerald-300",
